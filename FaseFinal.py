...
img_background = pygame.image.load("background_teste_fullhd21.png")
...
def fase1():
    ...
    img_background = pygame.image.load("arvore_final_verde1.png")
    ...
    img_background = pygame.image.load("arvore_final_verde2.png")
