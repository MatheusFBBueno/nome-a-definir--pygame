...
def fase1():
    ...
    chave1 = False
    chave2 = False
    img_escova = pygame.image.load("toothbrush.png")
    img_escova= pygame.transform.scale(img_escova,(25,25))
    escova = Interagivel(750,350,25,25,["Uma escova de dentes","escovar os dentes?","S/N"])
