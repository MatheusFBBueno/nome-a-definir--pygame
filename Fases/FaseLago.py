...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
background = pygame.image.load("images/FaseLago.png")
...
wall = Wall(0, 0, 800, 90)
wall_list.add(wall)
all_sprite_list.add(wall)
wall.paint(NADA)

wall = Wall(415, 0, 270, 250)
wall_list.add(wall)
all_sprite_list.add(wall)
wall.paint(NADA)

wall = Wall(75, 0, 50, 250)
wall_list.add(wall)
all_sprite_list.add(wall)
wall.paint(NADA)

wall = Wall(295, 185, 100, 20)
wall_list.add(wall)
all_sprite_list.add(wall)
wall.paint(NADA)

wall = Wall(415, 400, 270, 250)
wall_list.add(wall)
all_sprite_list.add(wall)
wall.paint(NADA)
